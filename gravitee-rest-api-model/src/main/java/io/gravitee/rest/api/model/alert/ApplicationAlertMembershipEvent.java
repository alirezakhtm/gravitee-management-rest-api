...
public class ApplicationAlertMembershipEvent {
    ...
    public ApplicationAlertMembershipEvent(Set<String> applicationIds, Set<String> groupIds) {
        this.applicationIds = applicationIds != null && !applicationIds.isEmpty() ? applicationIds : new HashSet<>();
        this.groupIds = groupIds != null && !groupIds.isEmpty() ? groupIds : new HashSet<>();
    }
